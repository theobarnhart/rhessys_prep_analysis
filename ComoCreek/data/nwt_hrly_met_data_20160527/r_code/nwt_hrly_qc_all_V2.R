...
library(plyr) #use for list and data frame manipulation
...
ggplot(hrly_data[["c1"]], aes(datetime, wind_spd_scalar)) + geom_point() + ylim(0,15) +
  labs(x = "Date", y = "Scalar wind speed (m/s)", title = "C1 Hourly Wind Speed (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_wind_c1_scal_hr_raw.png")
ggplot(hrly_data[["d1"]], aes(datetime, wind_spd_scalar)) + geom_point() + ylim(0,35) +
  labs(x = "Date", y = "Scalar wind speed (m/s)", title = "D1 Hourly Wind Speed (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_wind_d1_scal_hr_raw.png")
ggplot(hrly_data[["sdl"]], aes(datetime, wind_spd_scalar)) + geom_point() + ylim(0,30) +
  labs(x = "Date", y = "Scalar wind speed (m/s)", title = "SDL Hourly Wind Speed (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_wind_sdl_scal_hr_raw.png")
ggplot(hrly_data[["c1"]], aes(datetime, rh)) + geom_point() + ylim(0, 120) +
  labs(x = "Date", y = "Relative Humidity (%)", title = "C1 Hourly Relative Humidity (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_rh_c1_hr_raw.png")
ggplot(hrly_data[["d1"]], aes(datetime, rh)) + geom_point() + ylim(0, 120) +
  labs(x = "Date", y = "Relative Humidity (%)", title = "D1 Hourly Relative Humidity (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_rh_d1_hr_raw.png")
ggplot(hrly_data[["sdl"]], aes(datetime, rh)) + geom_point() + ylim(0, 120) +
  labs(x = "Date", y = "Relative Humidity (%)", title = "SDL Hourly Relative Humidity (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_rh_sdl_hr_raw.png")
ggplot(hrly_data[["c1"]], aes(datetime, sw_in_tot_mj)) + geom_point() + ylim(0, 5) +
  labs(x = "Date", y = expression("Total incoming solar (MJ "*m^-2*")"), title = "C1 Hourly Solar Rad. (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_sw_in_tot_mj_c1_hr_raw.png")
ggplot(hrly_data[["d1"]], aes(datetime, sw_in_tot_mj)) + geom_point() + ylim(0, 5) +
  labs(x = "Date", y = expression("Total incoming solar (MJ "*m^-2*")"), title = "D1 Hourly Solar Rad. (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_sw_in_tot_mj_d1_hr_raw.png")
ggplot(hrly_data[["sdl"]], aes(datetime, sw_in_tot_mj)) + geom_point() + ylim(0, 5) +
  labs(x = "Date", y = expression("Total incoming solar (MJ "*m^-2*")"), title = "SDL Hourly Solar Rad. (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_sw_in_tot_mj_sdl_hr_raw.png")
ggplot(hrly_data[["c1"]], aes(datetime, temp)) + geom_point() + ylim(-40, 40) +
  labs(x = "Date", y = expression("Air temperature ("*degree*C*")"), title = "C1 Hourly Temperature (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_temp_c1_hr_raw.png")
ggplot(hrly_data[["d1"]], aes(datetime, temp)) + geom_point() + ylim(-40, 40)+
  labs(x = "Date", y = expression("Air temperature ("*degree*C*")"), title = "D1 Hourly Temperature (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_temp_d1_hr_raw.png")
ggplot(hrly_data[["sdl"]], aes(datetime, temp)) + geom_point() + ylim(-40, 40)+
  labs(x = "Date", y = expression("Air temperature ("*degree*C*")"), title = "SDL Hourly Temperature (Non-QC)")
ggsave(path = "~/Documents/research/site_data/niwot/nwt_hrly_qc/plots/nwt_hrly_climate_plots_NOQC/", 
       filename = "nwt_temp_sdl_hr_raw.png")
...
n_stations = 3 #make a variable in case more added later
...
hour_cats <- letters[seq(1,8, by = 1)]
for(i in 1:length(temp) ){
...
#Manual check that each temp has proper number of rows
