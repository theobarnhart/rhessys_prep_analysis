...
# opt 28
	...
	gw2 = 0
        ...
        args = '%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s'%(gw1,gw2,sd,m,ksat,crd,trd,po,pa,snowtemp,raintemp,smtc,msed,strtyear,strtmonth,strtday,endyear,endmonth,endday,idx)
        cmd =  '%s %s'%(scrpt,args)
        print cmd
...
sampler.sample(3000, ngs=12, kstop = 30, pcento=0.00025, peps=0.00025)
