...
#        # define the parameters for the model
	...
	self.params = [spotpy.parameter.Uniform('gw1',0.0,1.0),
		    ...
		    spotpy.parameter.Uniform('sd',0.001,50.),
		    ...
		    spotpy.parameter.Uniform('a',0.0001,15),
		    spotpy.parameter.Uniform('b',0.,25),
		    spotpy.parameter.Uniform('c',0.,1)]
...
sampler = spotpy.algorithms.lhs(spotpy_setup, dbname='Como_LHS_%s'%(spotpy_setup.num), dbformat='csv', parallel='mpi')

sampler.sample(3500)

alert.send_alert('barnhatb@colorado.edu','RHESSys Como Sensitivity Analysis Finished','Your script has finished')
